...
function writeRichText(rte, html, width, height, buttons, readOnly) {
	if (isRichText) {
		...
		if (buttons == true) {
			...
			document.writeln('	<tr>');
			document.writeln('		<td>');
			document.writeln('			<select style=font-size:10px id="formatblock_' + rte + '" onchange="selectFont(\'' + rte + '\', this.id);">');
			...
			document.writeln('		</td>');
			document.writeln('		<td>');
			document.writeln('			<select style=font-size:10px id="fontname_' + rte + '" onchange="selectFont(\'' + rte + '\', this.id)">');
			...
			document.writeln('		</td>');
			document.writeln('		<td>');
			document.writeln('			<select style=font-size:10px unselectable="on" id="fontsize_' + rte + '" onchange="selectFont(\'' + rte + '\', this.id);">');
			...
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'sub.gif"  alt="Subscript" title="Subscript" onClick="rteCommand(\'' + rte + '\', \'Subscript\', \'\')"></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'sup.gif"  alt="Superscript" title="Superscript" onClick="rteCommand(\'' + rte + '\', \'Superscript\', \'\')"></td>');
